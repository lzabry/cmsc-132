...
public class SystemManager implements Manager, Serializable {
	...
	public boolean addExam(int examId, String title) {
		if (a.getExams().containsKey(examId)) {
			return false;
		} else {
			a.getExams().put(examId, new Exam(examId, title));
			return true;
		}
	...
	public void addMultipleChoiceQuestion(int examId, int questionNumber, String text, double points, String[] answer) {
		((Exam) a.getExams().get(examId)).addMultipleChoiceQuestion(questionNumber, text, points, answer);
	}
	...
	public void addFillInTheBlanksQuestion(int examId, int questionNumber, String text, double points,
			String[] answer) {
		((Exam) a.getExams().get(examId)).addFillInTheBlanksQuestion(questionNumber, text, points, answer);
	}
	...
	public String getKey(int examId) {
		if (a.getExams().get(examId) == null) {
			return "Exam not found";
		} else {
			return ((Exam) a.getExams().get(examId)).getKey();
		}
	}
	...
	public boolean addStudent(String name) {
		if (a.students.containsKey(name)) {
			return false;
		} else {
			a.students.put(name, new Student(name, a));
			return true;
		}
	}
	...
	public void answerTrueFalseQuestion(String studentName, int examId, int questionNumber, boolean answer) {
		a.answerQuestion(studentName, examId, questionNumber, answer);
	}
	...
	public double getExamScore(String studentName, int examId) {
		return a.getExamScore(studentName, examId);
	}
	...
	public String getGradingReport(String studentName, int examId) {
		return a.getGradingReport(studentName, examId);
	}
	...
	public void setLetterGradesCutoffs(String[] letterGrades, double[] cutoffs) {
		a.setLetterGradesCutoffs(letterGrades, cutoffs);
	}
	...
	public double getCourseNumericGrade(String studentName) {
		return a.getCourseNumericGrade(studentName);
	}
	...
	public String getCourseLetterGrade(String studentName) {
		return a.getCourseLetterGrade(studentName);
	}
	...
	public double getAverageScore(int examId) {
		return a.getAverageScore(examId);
	}
	...
	public Manager restoreManager(String fileName) {
		try {
			...
			SystemManager obj = (SystemManager) ois.readObject();
			ois.close();
			file.close();
			return obj;
		} catch (IOException e) {
